...
{
  if(eventtype == NSEventTypeLeftMouseDown || eventtype == NSEventTypeLeftMouseUp || eventtype == NSEventTypeLeftMouseDragged)
    return 1;
  else if(eventtype == NSEventTypeRightMouseDown || eventtype == NSEventTypeRightMouseUp || eventtype == NSEventTypeRightMouseDragged)
    return 2;	
  else if(eventtype == NSEventTypeOtherMouseDown || eventtype == NSEventTypeOtherMouseUp || eventtype == NSEventTypeOtherMouseDragged)
    return 3;  
  else 
    return 0;
}
